...
- 🏢 **Оплата в офисе** — бронирование без предоплаты, рассчитываетесь при визите
- 💳 **Оплата онлайн** — карта, **Apple Pay**, **Google Pay** через Stripe (депозит-холд)
...
| Поток | Успешное бронирование | `app/booking-success.tsx` |
